...
// a rank table is the service's own paperwork, so it says synker.
...

  {
    ...
    prov: {
      ...
      filedAs: "Civics chapter, general curriculum",
      reliability: 3,
      note: "Official. Keeps what its own institution was invited to celebrate.",
    },
    body: [
      "Four peoples hold seats at the Seated Quorum of the Four Hubs. This chapter covers the three who came to the Coalition by agreement. The Hiopi seat is treated in the chapter on the Great Space War.",
      "The Coalition was founded at Mars, in the settlement that ended the war for Sol's water, under the name Coalition of Human Worlds. For roughly eight and a half thousand Standard years that name was accurate. Charters were granted to houses that did hard work in distant places, and the gate network followed them out along the gravitic current.",
      "The Osnian were found by a survey of House Dionu, on a green, mountainous world in a cluster the current had only just reached. What followed is covered in the chapter on the Great Debate. Its outcome is stated here: the Osnian were raised to full technical parity, chartered a world of their own, Osnius, and took the second seat. A few centuries later the Standing Roll of Chartered Obligation was closed to new entry. The reason recorded at the time was continuity of obligation, a charter carrying duties across centuries that a body changing hands every generation could not be held to. No charter has been issued since. House Dionu itself is no longer on the Roll. Its line married into another house at a date the Roll does not record.",
      "The Carabil were found some thirty thousand years after the Great Space War, in a cold system around a red dwarf, four rocky worlds and five belts, living in what the survey logged first as debris and then as ships. No Roll remained open to admit them. Their seat rests on an entente instead, an exchange of hull for reach that was never written into the older instruments.",
      "The seat of the Coalition moved from Mars to Osnius early in this period. Mars by then was a single city from pole to pole, and its dry air did not suit the delegates of the other seated peoples who had to work there. The houses voted between Osnius and Terra. Osnius won.",
    ],
  },
  {
    id: "hist_transition",
    section: "history",
    kind: "Record",
    title: "The Transition to a Standing Force",
    gate: null,
    prov: {
      source: "Standing Staff of External War",
      filedAs: "Doctrine preface, founding record",
      reliability: 3,
      note: "The Staff's own founding record. Confident in tone throughout.",
    },
    body: [
      "The Coalition entered the present war with no military. The last one had ended some eighty thousand Standard years before, and nothing built for it survived in a form the Staff could put to use.",
      "The League survived. Its carriers were rated for months underway with a full complement aboard. Its academies certified synkers and meks to one standard across every hub. Its supply contracts moved mechs, spares, and fuel on a fixed schedule that predated the war by millennia. The founding order reassigned the whole of it in one season: carriers, academies, contracts, crews, and the governing body that became this Staff.",
      "Three League practices were kept by order, and the Staff records the reason for each.",
      "A lance answers to its lead while deployed, and to nobody above the lead. That was a sporting rule. It stays because a carrier working hundreds of light-years from the nearest command post cannot be directed from that post, and a mission runs up to twelve hours before automatic recall. The lead is the only officer inside that window.",
      "A carrier counts as a city for the purposes of Hiopi custom, and carries a crèche. The League adopted this so that Hiopi crews could serve a full season aboard, and the Staff had no way to deploy them without it.",
      "Each mech remains fitted to its own synker and mek pair. Standardising the fleet was costed in the first year and rejected. A lance that has flown its machines for a season loses fewer of them.",
      "Team names were retained by the battlegroups that inherited them. No order was issued on the point. There was no time to issue one.",
      "Personnel files from the first year record that the pace was demanding. The files are accurate.",
    ],
  },
  {
    id: "hist_unready",
    section: "history",
    kind: "Record",
    title: "Nobody Was Ready",
    gate: null,
    prov: {
      source: "Frontier Compact",
      filedAs: "Broadside, unofficial circulation",
      reliability: 1,
      note: "Partisan, and does not pretend otherwise.",
    },
    body: [
      "There was no army. Say it straight, because the Staff will not.",
      "There was a league. It had carriers because a season ran months and the crews lived aboard. It had academies because a sponsor wants a synker certified before it pays for one. It had a supply network because a fixture on one hub and a fixture on the next need the same spares in the same week. None of it was built to fight anything. When the Bloom reached the first colonies the Coalition took the league whole, kept the sponsors, kept the box seats, and pointed it at the enemy, because in eighty thousand years nobody had built anything else.",
      "The first colonies were ours. They went quiet one at a time for years while the Core filed the reports under natural hazard and the league finished its season. Nobody at the Table said the word war until a fixture had to be cancelled.",
      "Every crew that went had signed for a season. Nobody asked them to sign again. The lance rule, one lead and nobody above, was written for a fixture with a referee and a clock. It is the law your survival hangs on now, and the people who wrote it never had to live under it. The Staff will tell you the rule is kept because the carriers are too far out to command. Ask why the carriers are that far out, and who decided the Frontier would be where the war got fought.",
      "We do not know what the Coalition should have done instead. There was nothing else to do it with. We know what it did, and who it did it to.",
      "The Staff calls this a transition. Out here we lost half of everything past the Core before anyone in the Core called it a war.",
    ],
  },
  {
    id: "hist_league",
    ...
    prov: {
      source: "Meridian Institute, popular history",
      filedAs: "Excerpt, same volume as \"The Gladiator Days\"",
      reliability: 2,
      note: "Good on the shape. Loose on the dates.",
    },
    body: [
      "Start with the number, because the number is the whole story. At its height the League sold more seats in a single season than the Coalition had citizens at its founding. This Institute will not defend that figure to a decimal. Nobody who saw a hub fixture will argue with the shape of it.",
      "The sport came out of the Hiopi War. A species that had just fought three hundred years against the only enemy it had ever needed came home with more energy, more matter, and more idle hands than it knew what to do with, and put them in heavy armour in front of a crowd. The Heritage Broadcast will tell you the Coalition's sons and daughters chose the risk freely, in the arena, for glory alone. A Hiopi crew chief will tell you the arena was theirs first and the humans were in the stands. Both are on record.",
      "For the better part of fifty thousand years it grew. By the end there was one League, corporate top to bottom, the only institution in the Coalition no house could sit on the board of. You got in through the academies. You paid the fees, or if you were fast enough a sponsor paid them for you, and nobody on Roll or off was ever turned away for the wrong surname.",
      "A competition carrier was a city that moved. Crews lived aboard for a season. Hiopi crews kept their rites there, and the League wrote the carrier down as a city so they could. Two divisions filled the card. Mechs, synker on synker, was the one the crowds came for. Ships fought in their own division with weapons capped by rule, well below anything the engineers could not have cleared if asked. Every mech had one synker and one mek and was built for nobody else. Sponsors' colours on the hull, the pair's names on the leg.",
      "Most of it went to the front and came back as battlegroups, if it came back. What still runs is Core-side and quieter. This Institute's subscribers stopped writing in about Frontier fixtures years ago. There is nothing out there left to schedule.",
    ],
  },
  {
    id: "hist_debate",
    ...
    prov: {
      ...
      filedAs: "Civics chapter, general curriculum",
      reliability: 3,
      note: "Official. Teaches the vote and its size, and nothing further.",
    },
    body: [
      "Before the Osnian, the Coalition was the Coalition of Human Worlds. The name was accurate and nobody serving at the founding expected it to need changing.",
      "The survey that changed it was House Dionu's, working a cluster in a new arm of the galaxy at the far end of the gravitic current. The world was green and mountainous, close to half water by surface, and its people were in an early industrial age. Delegations were sent within the year, and the reaction across every chartered world is recorded as celebration.",
      "Two questions were then put to the houses and argued for more than a century. The first was the name, since an association of human worlds was no longer a description of what the Coalition was about to be. The second was parity: whether the Osnian should be brought to Coalition technical standard all at once, or by stages over generations.",
      "The name was settled first. The association became the Coalition of Enlightened, and this is the only time in its recorded history that the name has changed.",
      "The parity vote went to full standing at once. The expense is on record. It has not been proposed for any people found since. Osnius was chartered as the Osnian hub within the same generation, and took the second seat.",
      "Two further facts belong beside these. The Standing Roll of Chartered Obligation closed a few centuries later, and the Species Development Protective Protocol was adopted within the millennium, forbidding interference with any people found outside the Coalition. No species has been raised to parity since. The Hiopi were not. The Carabil arrived already at standard.",
    ],
  },
  {
    id: "hist_before_gate",
    ...
    prov: {
      ...
      filedAs: "Excerpt, same volume as \"The Gladiator Days\"",
      reliability: 2,
      note: "Good on the shape. Silent on specific years.",
    },
    body: [
      "For a thousand years and more after its people first left the ground, the Coalition's home system was the whole of the map. Every world in it worth standing on was stood on. Every generation tried for the next star out and failed, because surviving a launch and arriving somewhere else alive are two different problems and the second one does not care how well you solved the first.",
      "The expensive failure is the one still spoken of. A generation that thought it had solved real speed between the stars built the ships to prove it and crewed them. The mechanism that killed them is taught in every academy physics module now and was not understood then: a ship going that fast pushes everything in front of it, and when it stops, all of it arrives at once. Crew after crew came home to the edge of the system and died in the last second of the trip. No single disaster carries the name. The losses came at a rate, for close to two centuries, until the whole line of research was renounced in a signed public instrument, the nearest the species has to a shared wound.",
      "What followed was patience. Slow ships inside the system. Unmanned swarms sent outward with no expectation of hearing back. Corporate arks, launched on promises nobody aboard would live to see kept, several of which fell silent and stayed silent. Some of those were found again a thousand years later, by the charter houses, still running, carrying populations the launch manifests did not describe.",
      "The bottleneck broke from a different direction. The people who broke it had no interest in ships. They were trying to move a crate between two facilities on opposite sides of a planet, and they did. What that opened onto is the subject of the next volume.",
    ],
  },
  {
    id: "hist_gate_water",
    section: "history",
    kind: "Record",
    title: "Terra, As It Was",
    gate: null,
    prov: {
      source: "Terra Preservation Board",
      filedAs: "Gallery placards, Entrance Hall through Hall Nine",
      reliability: 3,
      note: "The Board's own placards. Doesn't say whether the choice was kind, only that it was made.",
    },
    body: [
      "PLACARD 1, ENTRANCE HALL",
      "The world you are standing on is held at the last year before its people first left the ground. Nothing later is reproduced. The Board's charter fixes the date and the Board does not revise it.",
      "This is not the world as it stood on the day it was struck. That world was a thousand years older, gate-linked to Mars and to the outer moons, and it does not survive anywhere.",
      "PLACARD 4, THE STRIKE",
      "By the time of the war, a gate could put a person on Mars in an afternoon, and every colony in the system drew on the same water. The outer moons held most of it. Their government sat at Europa and called itself the Deep System.",
      "Terra and Mars allied to take the moons' water under their own administration. Before the alliance could act, the Deep System launched a kinetic weapon at Terra. The target was chosen. Mars, the stronger of the two, was not struck.",
      "Terra did not recover in the lifetime of anyone who saw it hit. Restoration took five thousand years.",
      "PLACARD 9, AFTER",
      "The Deep System did not survive the strike as a government. Outrage across the system stripped it of every ally it had, and once there was no Deep System left to hold the moons' water, the water was no longer held. The peace was signed at Mars. The Coalition was founded there under the name Coalition of Human Worlds.",
      "Long afterward, when the seat of the Coalition left Mars, Terra was put forward to receive it. The houses chose Osnius.",
    ],
  },
