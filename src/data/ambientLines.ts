...
//
// Munti Respect bank folded in, 27 Aug 2026 (roadmap #14) — the 18 lines
// from claude/Bloom_Wars_Munti_Respect_Line_Bank_v1.md (delivered earlier
// the same day, deliberately kept in its own doc rather than merged into
// this pool at delivery time) are now part of the 720-line total below,
// one line appended to its already-tagged catalyst/echo/stage bucket —
// same schema as everything else here, no new fields, exactly as that
// doc's own §2 said it would take. Verified two ways: every one of the 18
// lines' exact text is present in its intended bucket, and the bank's
// total line count is exactly 702 (this file's prior total) + 18 = 720,
// confirming nothing else moved or duplicated during the merge. The
// per-catalyst delivery doc (Bloom_Wars_Ambient_Line_Bank_Delivery_v1.md)
// and the Munti Respect doc itself were both updated the same day to
// match — see either doc for the fold-in note.

export const LINE_BANK: Record<Catalyst, Record<Echo, Record<Stage, string[]>>> = {
  wolf: {
    love: {
      green: ["First time out and you already had my back — I won't forget that.", "We're a team now, right? Say we're a team.", "Just tell me where you need me and I'll be there. That's — that's the whole plan, right? Stick together?", "Nobody warned me how much of this job is just knowing where everyone else is standing.", "That was the first time I actually felt like part of something instead of just next to it.", "I moved because you moved. Didn't even think about it. Is that bad?", "Deal me in. I'm terrible at this, but I'd rather lose with everyone watching than win alone.", "One drink. I want to remember tonight, not black it out.", "Okay — okay, that's twice now I've almost had a heart attack over someone who's standing right there laughing at me.", "First thing anyone told me in this unit wasn't 'don't die.' It was 'don't let the Munti go down first.' Everything else about staying alive comes after that one rule."],
  ...
  crow: {
    ...
    sadness: {
      ...
      command: ["I've built a whole system for sitting with this eventually. Not today though.", "Years of practice and I still need a minute before I can feel this properly.", "I've got a whole file of near-misses like that one. I don't reread it for fun anymore. I reread it because it reminds me why we do the rest of this.", "I've catalogued every way this war surprises you. The grief ones I still file under 'pending.'", "Lost a Munti once. Half the squad who went quiet that week never even flew a mission with him. Turns out that particular grief doesn't check your logbook first — it just checks whether anyone's left to catch the next fall."]
    }
  },
  raven: {
    love: {
      green: ["Still new at this whole 'giving advice' thing — but you're doing better than you think.", "Ask me anything. I might actually know the answer now.", "Actually, you'll want to angle your approach two degrees wider than that — I read it in a manual, don't look at me like that.", "I know I sound like I've done this for years. I have not. I've just read everything.", "Let me walk you through why that worked. I promise it's useful and not just me showing off. Mostly.", "Told you the approach angle mattered. I wasn't sure until it actually worked, if I'm honest.", "I called the timing on that and got lucky it landed right. I'll take it.", "Next time, hold two turns longer before the push. I'm learning this in real time right alongside you.", "I can walk you through Fletchers technique or we can just play. Your call. I vote technique.", "One drink and I promise not to explain the fermentation process. No promises on anything else.", "First lesson I give any green pilot, before tactics, before anything: learn exactly where your Munti's standing. Every other lesson assumes that one already landed."],
    ...
    anger: {
      ...
      command: ["Years of teaching and this still happens. That's on all of us, me included.", "I've taught this exact lesson before. Somebody didn't listen.", "I've rewritten that doctrine twice with better information. Command shelved it twice. Third draft's going over their heads.", "Every shortcut you're defending, I've watched cost somebody something. Pick a different hill.", "Somebody left the Munti exposed on that approach. That's not bad luck. That's a briefing nobody actually sat through — because the day we lose him is the day the rest of this unit stops getting second chances."]
    },
    sadness: {
