...
const MUSTER_TILES: TileType[][] = [
  ...
  ["deploy", "deploy", "plain", "road", "road", "plain", "rubble", "rubble", "plain", "plain", "plain", "rubble", "rubble", "plain", "road", "road", "plain", "plain", "spawn", "scrub"],
...
const FORAGING_PARTY_TILES: TileType[][] = [
  ...
  ["ridge", "ridge", "ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "sump", "plain", "ridge", "ridge", "ridge"],
  ["scrub", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "sump", "plain", "plain", "plain", "scrub"],
  ["scrub", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "rubble", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "sump", "spawn", "plain", "plain", "scrub"],
  ["deploy", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "rubble", "rubble", "plain", "plain", "plain", "plain", "plain", "plain", "sump", "plain", "plain", "plain", "exit"],
  ...
  ["deploy", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "structure", "structure", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "exit", "plain"],
  ["deploy", "deploy", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "structure", "structure", "plain", "plain", "plain", "plain", "sump", "plain", "plain", "exit", "exit"],
  ["deploy", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "rubble", "rubble", "plain", "plain", "plain", "plain", "plain", "plain", "sump", "plain", "plain", "plain", "exit"],
  ["scrub", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "rubble", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "sump", "spawn", "plain", "plain", "scrub"],
  ["scrub", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "sump", "plain", "plain", "plain", "scrub"],
  ["ridge", "ridge", "ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "sump", "plain", "ridge", "ridge", "ridge"],
...
const THE_AMARANTH_BETRAYAL_TILES: TileType[][] = [
  ...
  ["scrub", "scrub", "plain", "plain", "plain", "plain", "plain", "plain", "spawn", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "spawn", "plain", "wall", "wall", "wall", "wall", "wall", "scrub"],
  ["scrub", "scrub", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "exit", "exit", "exit", "wall", "scrub"],
  ["scrub", "scrub", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "structure", "structure", "plain", "plain", "plain", "plain", "plain", "plain", "wall", "exit", "exit", "exit", "wall", "scrub"],
  ["scrub", "scrub", "plain", "deploy", "deploy", "plain", "plain", "plain", "plain", "plain", "structure", "structure", "plain", "plain", "plain", "plain", "plain", "plain", "wall", "plain", "plain", "plain", "wall", "scrub"],
  ["scrub", "scrub", "plain", "deploy", "deploy", "plain", "plain", "plain", "plain", "road", "road", "road", "road", "road", "road", "road", "plain", "plain", "wall", "plain", "plain", "plain", "wall", "scrub"],
  ["scrub", "scrub", "plain", "deploy", "plain", "plain", "plain", "plain", "plain", "plain", "structure", "structure", "plain", "plain", "plain", "plain", "plain", "plain", "wall", "plain", "plain", "plain", "wall", "scrub"],
  ["scrub", "scrub", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "structure", "structure", "plain", "plain", "plain", "plain", "plain", "plain", "wall", "exit", "exit", "exit", "wall", "scrub"],
  ["scrub", "scrub", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "bloom_mat", "bloom_mat", "bloom_mat", "bloom_mat", "plain", "plain", "exit", "exit", "exit", "wall", "scrub"],
  ["scrub", "scrub", "plain", "plain", "plain", "plain", "plain", "plain", "spawn", "plain", "plain", "plain", "plain", "bloom_mat", "bloom_mat", "bloom_mat", "bloom_mat", "plain", "wall", "wall", "wall", "wall", "wall", "scrub"],
  ["scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub"],
  ["ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge"],
];
...
const THE_LONG_WALK_BACK_TILES: TileType[][] = [
  ["ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "sump", "sump", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge"],
  ["scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "sump", "sump", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub"],
  ["scrub", "scrub", "plain", "plain", "plain", "plain", "sump", "sump", "plain", "plain", "plain", "plain", "sump", "sump", "sump", "plain", "plain", "plain", "plain", "plain", "plain", "spawn", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "scrub", "scrub"],
  ["scrub", "scrub", "plain", "plain", "plain", "plain", "sump", "sump", "plain", "plain", "plain", "plain", "sump", "sump", "sump", "plain", "plain", "plain", "plain", "rubble", "rubble", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "spawn", "plain", "plain", "plain", "scrub", "scrub"],
  ["scrub", "scrub", "plain", "plain", "plain", "plain", "sump", "sump", "plain", "plain", "plain", "plain", "sump", "sump", "sump", "plain", "plain", "plain", "plain", "rubble", "rubble", "plain", "plain", "plain", "plain", "plain", "rubble", "rubble", "plain", "plain", "plain", "plain", "scrub", "scrub"],
  ...
  ["scrub", "scrub", "plain", "plain", "plain", "plain", "sump", "sump", "plain", "plain", "plain", "plain", "sump", "sump", "sump", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "rubble", "rubble", "plain", "plain", "rubble", "rubble", "plain", "plain", "plain", "plain", "scrub", "scrub"],
  ["scrub", "scrub", "plain", "plain", "plain", "plain", "sump", "sump", "plain", "plain", "plain", "plain", "sump", "sump", "sump", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "rubble", "rubble", "plain", "plain", "plain", "plain", "spawn", "plain", "plain", "plain", "scrub", "scrub"],
  ["scrub", "scrub", "plain", "plain", "plain", "plain", "sump", "sump", "plain", "plain", "plain", "plain", "sump", "sump", "sump", "plain", "plain", "plain", "plain", "plain", "plain", "spawn", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "scrub", "scrub"],
  ["scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "sump", "sump", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub"],
  ["ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "sump", "sump", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge"],
];
...
const NEW_COLORS_TILES: TileType[][] = [
  ...
  ["deploy", "plain", "plain", "scrub", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "bloom_mat", "bloom_mat", "bloom_mat", "plain", "plain", "plain"],
  ["deploy", "plain", "plain", "scrub", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "bloom_mat", "bloom_mat", "bloom_mat", "plain", "plain", "plain"],
  ["deploy", "plain", "plain", "scrub", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain"],
  ["deploy", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge", "road", "road", "road", "road", "road", "road", "plain", "plain", "plain", "plain", "spawn", "spawn", "plain"],
  ["deploy", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "road", "road", "road", "road", "road", "road", "plain", "plain", "plain", "plain", "plain", "plain", "plain"],
...
const WELLROOT_TILES: TileType[][] = [
  ...
  ["wall", "scrub", "deploy", "deploy", "deploy", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "wall"],
  ["wall", "scrub", "deploy", "deploy", "deploy", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "spawn", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "wall"],
  ["wall", "scrub", "deploy", "deploy", "deploy", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "wall"],
  ["wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "scrub", "scrub", "wall", "wall", "wall", "wall"],
  ...
  ["wall", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "bloom_mat", "bloom_mat", "bloom_mat", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "wall"],
  ["wall", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "bloom_mat", "bloom_mat", "bloom_mat", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "spawn", "scrub", "scrub", "scrub", "scrub", "scrub", "wall"],
  ["wall", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "bloom_mat", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "wall"],
  ["wall", "wall", "wall", "wall", "wall", "scrub", "scrub", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall"],
  ["wall", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "wall"],
  ...
  ["wall", "exit", "exit", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "wall"],
  ["wall", "exit", "exit", "exit", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "wall"],
  ["wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall"],
];
...
const THE_AMARANTH_ACCORD_TILES: TileType[][] = [
  ["wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall"],
  ["wall", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "wall", "scrub", "scrub", "scrub", "scrub", "scrub", "wall"],
  ["wall", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "spawn", "scrub", "wall"],
  ["wall", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "structure", "structure", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "wall", "exit", "exit", "exit", "exit", "exit", "wall"],
  ["wall", "deploy", "deploy", "deploy", "scrub", "scrub", "scrub", "scrub", "scrub", "structure", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "wall", "exit", "exit", "exit", "exit", "exit", "wall"],
  ["wall", "deploy", "deploy", "deploy", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "wall", "exit", "exit", "exit", "exit", "exit", "wall"],
  ["wall", "deploy", "deploy", "deploy", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "bloom_mat", "bloom_mat", "scrub", "scrub", "scrub", "scrub", "scrub", "wall", "exit", "exit", "exit", "exit", "exit", "wall"],
  ["wall", "deploy", "deploy", "deploy", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "wall", "exit", "exit", "exit", "exit", "exit", "wall"],
  ["wall", "deploy", "deploy", "deploy", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "structure", "scrub", "scrub", "scrub", "wall", "exit", "exit", "exit", "exit", "exit", "wall"],
  ["wall", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "structure", "structure", "scrub", "scrub", "wall", "exit", "exit", "exit", "exit", "exit", "wall"],
  ["wall", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "wall"],
  ["wall", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "scrub", "wall", "scrub", "scrub", "scrub", "scrub", "scrub", "wall"],
  ["wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "wall"],
];
...
const OUTER_RING_FALLS_TILES: TileType[][] = [
  ...
  ["ridge", "plain", "deploy", "deploy", "deploy", "deploy", "plain", "plain", "plain", "wall", "hold", "hold", "hold", "hold", "plain", "plain", "scrub", "scrub", "scrub", "scrub", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "deploy", "deploy", "deploy", "deploy", "plain", "plain", "plain", "plain", "hold", "hold", "hold", "hold", "plain", "plain", "scrub", "scrub", "scrub", "rubble", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "deploy", "deploy", "deploy", "deploy", "plain", "plain", "plain", "plain", "hold", "hold", "hold", "hold", "plain", "plain", "scrub", "scrub", "rubble", "scrub", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "spawn", "ridge"],
  ["ridge", "plain", "deploy", "deploy", "deploy", "deploy", "plain", "plain", "plain", "wall", "hold", "hold", "hold", "hold", "plain", "plain", "scrub", "rubble", "scrub", "scrub", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "spawn", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "wall", "wall", "wall", "wall", "wall", "wall", "plain", "rubble", "scrub", "scrub", "scrub", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
...
// All four grids generated and BFS-validated via a throwaway gen_maps7.py
// script (same disciplined-then-deleted pattern as gen_maps5.py/
// gen_maps6.py — see the build log addendum for the validation summary),
// deliberately reusing the single-doorway-room shape Missions 27/29/32
// already proved out for hold_zone rather than inventing a first-time
// two-doorway room for the campaign's own final two hold_zone missions —
// the "ring" framing comes from wave count/staggered approach corridors,
// not from a riskier room topology.

// Mission 33, "The Innermost Ring" (hold_zone, multi-wave — "tone shifts
// from win to survive"). Deploy sits just west of a single-doorway walled
// room; three spawn seams (north corridor, east flank, south corridor) all
// have to route around the room's solid east/north/south walls to reach the
// one west-facing doorway, same "corridor-staggered, close enough to be in
// vision immediately" discipline Missions 27/29 learned the hard way —
// actual wave spawnAt coordinates in campaignAmaranth.ts sit in the
// corridors near the doorway, not on this map's own decorative far-edge
// "spawn" tiles.
const THE_INNERMOST_RING_TILES: TileType[][] = [
  ["ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "scrub", "scrub", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "rubble", "rubble", "rubble", "rubble", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "rubble", "rubble", "rubble", "rubble", "plain", "plain", "plain", "spawn", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "deploy", "deploy", "deploy", "deploy", "plain", "plain", "plain", "plain", "wall", "hold", "hold", "hold", "hold", "hold", "wall", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "deploy", "deploy", "deploy", "deploy", "plain", "plain", "plain", "plain", "plain", "hold", "hold", "hold", "hold", "hold", "wall", "plain", "plain", "plain", "plain", "spawn", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "deploy", "deploy", "deploy", "deploy", "plain", "plain", "plain", "plain", "plain", "hold", "hold", "hold", "hold", "hold", "wall", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "deploy", "deploy", "deploy", "deploy", "plain", "plain", "plain", "plain", "wall", "hold", "hold", "hold", "hold", "hold", "wall", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
...
// Mission 34, "No Word from the Fleet" (survive_n_turns, darkest hour — no
// hold/defend zone, the squad just has to still be standing at turnLimit).
// Open field, deploy centered, eight spawn tiles on all four approach edges
// so pressure comes from every direction at once.
const NO_WORD_FROM_THE_FLEET_TILES: TileType[][] = [
  ["ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "spawn", "spawn", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "rubble", "rubble", "plain", "plain", "plain", "plain", "plain", "plain", "rubble", "rubble", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "structure", "structure", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "structure", "structure", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "structure", "structure", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "structure", "structure", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "deploy", "deploy", "deploy", "deploy", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "spawn", "scrub", "scrub", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "deploy", "deploy", "deploy", "deploy", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "scrub", "scrub", "spawn", "ridge"],
  ["ridge", "spawn", "scrub", "scrub", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "deploy", "deploy", "deploy", "deploy", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "scrub", "scrub", "spawn", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "deploy", "deploy", "deploy", "deploy", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "structure", "structure", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "structure", "structure", "plain", "plain", "plain", "ridge"],
...
// up to 5 (data/bloom.ts) reaches the whole room from here, not just a
...
// way, since (18,12) was never tagged "hold" in the first place.
const THE_LAST_RING_TILES: TileType[][] = [
  ["ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "scrub", "scrub", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "rubble", "rubble", "rubble", "rubble", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "rubble", "rubble", "rubble", "rubble", "plain", "plain", "plain", "plain", "spawn", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "deploy", "deploy", "deploy", "deploy", "plain", "plain", "plain", "plain", "plain", "wall", "hold", "hold", "hold", "hold", "hold", "wall", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "deploy", "deploy", "deploy", "deploy", "plain", "plain", "plain", "plain", "plain", "plain", "hold", "hold", "hold", "hold", "hold", "wall", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "spawn", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "deploy", "deploy", "deploy", "deploy", "plain", "plain", "plain", "plain", "plain", "plain", "hold", "hold", "hold", "hold", "hold", "wall", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "deploy", "deploy", "deploy", "deploy", "plain", "plain", "plain", "plain", "plain", "wall", "hold", "hold", "hold", "hold", "hold", "wall", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "wall", "wall", "wall", "wall", "wall", "wall", "wall", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "wall", "structure", "wall", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "wall", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "rubble", "rubble", "rubble", "rubble", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "rubble", "rubble", "rubble", "rubble", "plain", "plain", "plain", "plain", "spawn", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "scrub", "scrub", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge"],
];

// Mission 36, "Until Relief" (survive_n_turns, campaign finale). Biggest
// open field in the campaign, deploy centered, twelve spawn tiles across
// all four edges plus all four corners — the last, largest swarm, thrown
// from every direction at once while the relief fleet's countdown runs.
const UNTIL_RELIEF_TILES: TileType[][] = [
  ["ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "spawn", "spawn", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "rubble", "rubble", "rubble", "rubble", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "spawn", "structure", "structure", "structure", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "structure", "structure", "structure", "spawn", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "structure", "structure", "structure", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "structure", "structure", "structure", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "rubble", "rubble", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "rubble", "rubble", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "deploy", "deploy", "deploy", "deploy", "deploy", "deploy", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "spawn", "scrub", "scrub", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "deploy", "deploy", "deploy", "deploy", "deploy", "deploy", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "scrub", "scrub", "spawn", "ridge"],
  ["ridge", "spawn", "scrub", "scrub", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "deploy", "deploy", "deploy", "deploy", "deploy", "deploy", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "scrub", "scrub", "spawn", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "deploy", "deploy", "deploy", "deploy", "deploy", "deploy", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
  ["ridge", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "rubble", "rubble", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "rubble", "rubble", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "plain", "ridge"],
...
export const map_amaranth_the_innermost_ring = makeMap("map_amaranth_the_innermost_ring", "The Innermost Ring", 28, 16, THE_INNERMOST_RING_TILES);
export const map_amaranth_no_word_from_the_fleet = makeMap("map_amaranth_no_word_from_the_fleet", "No Word from the Fleet", 26, 16, NO_WORD_FROM_THE_FLEET_TILES);
export const map_amaranth_the_last_ring = makeMap("map_amaranth_the_last_ring", "The Last Ring", 32, 17, THE_LAST_RING_TILES);
export const map_amaranth_until_relief = makeMap("map_amaranth_until_relief", "Until Relief", 30, 18, UNTIL_RELIEF_TILES);
